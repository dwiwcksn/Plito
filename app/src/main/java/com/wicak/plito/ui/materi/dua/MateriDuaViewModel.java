...
public class MateriDuaViewModel extends RecyclerView.ViewHolder {
    ...
    public MateriDuaViewModel(View itemView) {
        super(itemView);
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                switch (MateriDuaViewModel.this.getAdapterPosition()) {
                    case 0:
